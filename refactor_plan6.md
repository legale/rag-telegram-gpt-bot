...
- [ ] file=src/core/message_search.py func=search_message_links упростить: вынести получение link info из chunk в _get_link_info_from_chunk(), построение link в _build_message_link()
